...
df = pd.read_csv('../../data/interim/catboost_clean_df.csv')
...
# Save the dataframes
df_train.to_csv('../../data/processed/catboost_train_df.csv', index=False)
df_test.to_csv('../../data/processed/catboost_test_df.csv', index=False)
