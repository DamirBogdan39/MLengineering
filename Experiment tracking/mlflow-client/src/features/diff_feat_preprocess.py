...
df = pd.read_csv('../../data/interim/diff_feat_clean_df.csv')
...
df_train.to_csv('../../data/processed/diff_feat_train_df_1.csv', index=False)
df_test.to_csv('../../data/processed/diff_feat_test_df_1.csv', index=False)
...
# Save the dataframes
df_train.to_csv('../../data/processed/diff_feat_train_df_2.csv', index=False)
df_test.to_csv('../../data/processed/diff_feat_test_df_2.csv', index=False)
