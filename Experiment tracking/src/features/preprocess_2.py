...
df = pd.read_csv('../../data/interim/clean_df.csv')
...
# Save the dataframes
df_train.to_csv('../../data/processed/train_df_2.csv', index=False)
df_test.to_csv('../../data/processed/test_df_2.csv', index=False)
