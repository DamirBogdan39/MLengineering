...
# Read the data
train_df = pd.read_csv('../../data/processed/diff_feat_train_df_1.csv')
test_df = pd.read_csv('../../data/processed/diff_feat_test_df_1.csv')
...
train_df_2 = pd.read_csv('../../data/processed/diff_feat_train_df_2.csv')
test_df_2 = pd.read_csv('../../data/processed/diff_feat_test_df_2.csv')
